        ...
        public virtual void ExportProductsToXlsx(Stream stream, IList<Product> products)
        {
            ...
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                foreach (var p in products)
                {
                    ...
                    var pictures = _pictureService.GetPicturesByProductId(p.Id);
                    ...
                    col++;
                    worksheet.Cells[row, col].Value = picture4;
                    col++;
                    worksheet.Cells[row, col].Value = picture5;
                    col++;
                    worksheet.Cells[row, col].Value = picture6;
                    col++;
                    worksheet.Cells[row, col].Value = picture7;
                    col++;
                    worksheet.Cells[row, col].Value = picture8;
                    col++;
